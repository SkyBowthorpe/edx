...
#setting seed so the outcome will be predictable
...
edx%>%count(movieId)%>%
  ...
  scale_x_log10()+xlab('movies rating count') 
...
To further improve the movel we will now add the effect of users.  The effect aims to account for users that generally rate movies high or lower.
...
I imagine you could further improve the model by fitting to other attributes like genre, MPAA ratings, and studio that produced the movie.  
